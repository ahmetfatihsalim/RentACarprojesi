    ...
    public class YoneticiRepository : IRepository<Yonetici>, IDisposable
    {
        ...
        public bool DeletedById(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("YoneticiRepository::Insert:Error occured.", ex);
            }
        }
        public bool Insert(Yonetici entity)
        {
            _rowsAffected = 0;
            _errorCode = 0;
            ...
            try
            {
                ...
                query.Append("( [Ad], [Soyad], [Yas], [Parola], [KimlikNo], [Maas], [Ehliyet], [YoneticiMi], [SirketID] ) ");
                query.Append("VALUES ");
                query.Append(
                    "( @Ad, @Soyad, @Yas, @Parola, @KimlikNo, @Maas, @Ehliyet, @YoneticiMi, @SirketID ) ");
                query.Append("SELECT @intErrorCode=@@ERROR;");
        ...
        public IList<Yonetici> SelectAll()
        {
            _errorCode = 0;
            _rowsAffected = 0;
            ...
            try
            {
                ...
                query.Append("SELECT ");
                query.Append(
                    "[KullaniciID], [Ad], [Soyad], [Yas], [Parola], [KimlikNo], [Maas], [Ehliyet], [YoneticiMi], [SirketID] ");
                query.Append("FROM [dbo].[tbl_Kullanicilar] ");
                query.Append("SELECT @intErrorCode=@@ERROR; ");
            ...
            {
                LogHelper.Log(LogTarget.File, ExceptionHelper.ExceptionToString(ex), true);
                throw new Exception("YoneticiRepository::SelectAll:Error occured.", ex);
            }
        }
        public Yonetici SelectedById(int id)
        {
            _errorCode = 0;
            _rowsAffected = 0;
            ...
            try
            {
                ...
                yonetici.AltKademedeCalisanlar = new CalisanRepository().SelectAll().Where(calisan => calisan.Yoneticisi.Equals(yonetici.KullaniciID)).ToList();
            ...
            {
                LogHelper.Log(LogTarget.File, ExceptionHelper.ExceptionToString(ex), true);
                throw new Exception("YoneticiRepository::SelectById:Error occured.", ex);
            }
        }
        public bool Update(Yonetici entity)
        {
            _rowsAffected = 0;
            _errorCode = 0;
            ...
            try
            {
                ...
                query.Append(" SET [Ad] = @Ad, [Soyad] = @Soyad, [Yas] = @Yas, [Parola] = @Parola, [KimlikNo] = @KimlikNo, [Maas] = @Maas, [Ehliyet] = @Ehliyet, [YoneticiMi] = @YoneticiMi, [SirketID] = @SirketID ");
                query.Append(" WHERE ");
            ...
            {
                LogHelper.Log(LogTarget.File, ExceptionHelper.ExceptionToString(ex), true);
                throw new Exception("YoneticiRepository::Update:Error occured.", ex);
            }
        }
    }
}
